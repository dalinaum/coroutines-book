...
### 코드 2-13 파라미터를 일부만 지정 (partial-parameter.kt)
...
### 코드 2-14 지명 인자 (named-argument.kt)
...
### 코드 2-17 생성자와 프로퍼티 (constructor.kt)
...
### 코드 2-18 바디 안의 생성자 (secondary-constructor.kt)
...
### 코드 2-19 주 생성자와 부 생성자 (constructors.kt)
...
### 코드 2-23 프로퍼티 세터 (propoerty-setter.kt)
...
### 코드 2-24 프로퍼티 게터 (property-getter.kt)
...
### 코드 2-25 뒷받침하는 프로퍼티 (backing-property.kt)
